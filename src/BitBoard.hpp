...
public:
    ...
    constexpr BitBoard GetEnPassantBB()const {return (info_.en_passant_sq_) ? Magics::IndexToBB(info_.en_passant_sq_) : 0ull;}

    constexpr Sq GetEnPassantSq()const {return info_.en_passant_sq_;}
